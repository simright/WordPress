...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields   = array(
		...
		'avatar' => '<p class="comment-form-avatar">' . '<label for="avatar">' . __( 'Avatar' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
					'<input id="avatar" name="avatar" type="text" value="' . esc_attr( $commenter['comment_avatar'] ) .'"' . $aria_req . $html_req . ' /></p>',
	);
